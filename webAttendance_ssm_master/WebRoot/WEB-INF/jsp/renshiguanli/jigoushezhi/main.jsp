...
<html>
  <head>
   ...
   <SCRIPT type="text/javascript">
	   ...
	   $.fn.zTree.init($("#treeDemo"), setting, zNode);
		...
		if(bianhao!=""&& mingcheng!=""){
		 ...
		 alert("该机构名称或编号已经存在，请重新输入！");
		  ...
		  ajax("/setDeparment/update.do?name="+mingcheng+"&number="+bianhao+"&remark="+remark+"&departmentid="+departmentid,"修改");
		  	} 
		}
		else{
		alert("机构编号或机构名称不能为空");
		...
		//机构删除操作
		function dpdelete(){
			ajax("/setDeparment/delete.do?id="+departmentid,"删除");
		}
    ...
    <div class="twodiv">
   <fieldset>
    <legend style="margin-bottom: 5px;">请选择您要进行的操作</legend>
    <table>
    <tr>
    <td colspan="2"><div>
    <span
									...
									class="input-group-btn">
									<button id="btndpupdate" type="button" class="btn btn-primary"
										onclick="dpupdate()"
									...
									<span class="input-group-btn"></span> <span
									class="input-group-btn">
									<button  id="btndpcancle" type="reset" onclick="dpcancle()" class="btn btn-primary">
    ...
    <div>
    <fieldset>
    <legend style="margin-bottom: 5px;">职务修改</legend> 
    <button id="btndpinsert" type="button" 
