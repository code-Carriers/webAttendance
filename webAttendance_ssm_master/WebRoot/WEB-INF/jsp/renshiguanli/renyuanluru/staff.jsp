	...
	function selectAllStaff() {
		$.ajax({
					...
					success : function(data) {
						...
						/* alert(data.length); */
						for ( var i = 0; i < data.length; i++) {
							/* var result = data[i].headimage.indexOf("Root");
							if(result != -1){
							data[i].headimage = data[i].headimage.substring(39);
							} */
							 var xingbie = data[i].sex== "1" ? "男" : "女" ;
							var html = "<tr onclick='onclickStaffRow(this)'><td><a href='javascript:deleteStaff("
									+ data[i].staffid
									+ ")'>【删除】</a><a href='javascript:updateStaff("
									+ data[i].staffid
									+ ")'>【编辑】</a></td>"
									+ "<td><a><img style='width:50px;height:38px'  src='../pic/"
									+ data[i].headimage
									+ "'/></a></td>" 
									+ "<td>"
									+ data[i].staffname
	...
	function updateStaff(staffid) {
		...
		$.ajax({
			...
			success : function(data) {
				...
				/* $("#image-view")[0].src = + data[0].headimage; */
...
<body style="text-align: center">
	...
	<div id="menuContent" class="menuContent"
		...
		<ul id="treeDemo" class="ztree" style="margin-top: 20px; width: 110px;">
		</ul>
	</div> 
	...
	<div>
		<fieldset>
			...
			<div class="table-responsive"
				style="position:absolute ;max-height:550px;min-height: 540px;overflow-x: auto ;max-width: 2400px;">
				<table id="sample-table-2"
					style="border: 2px solid #dddddd;width: 1800px;"
											...
											<table class="table table-bordered"
												...
												<tr>
													...
													<td>
														...
														<input name="file_img" type="file" id="upimg"
												...
												<tr>
													...
													<td><label> <input id="boy" name="sex" checked="checked"
													...
													<td style="background-color: #ebf3fb;">
														<div style="font-size: 17px;" align='right'>手机号码</div></td>
												...
												<tr>
													...
													<td style="background-color: #ebf3fb;">
														<div style="font-size: 17px;" align='right'>权限</div></td>

													<td colspan="">
														<select style="width: 258px;" id="remark" name="remark" type="text" class="form-control">
															<option value="0">HR权限</option>
															<option value="1">部门经理权限</option>
												...
												<tr id="thistr">
													...
													<td><input name="username" id="username" type="text"
														class="form-control"></td>
													<td id="u6" style="background-color: #ebf3fb;">
														<div style="font-size: 17px;" align='right'>密码</div></td>
													<td><input type="password" id="password" name="password"
														class="form-control">
													</td>
													<td id="thistr1" style="background-color: #ebf3fb;">
														<div style="font-size: 17px;" align='right'>确认密码</div></td>
													<td><input id="thistr2" type="password" id="topassword" name="topassword"
