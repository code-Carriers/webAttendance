	...
	function selectAllStaff() {
		$
				.ajax({
					async : false,//同步异步
					type : 'post',
					url : "${ctx}/staff/selectAllStaff2.do?",
					data : {
					...
					success : function(data) {
						...
						for ( var i = 0; i < data.length; i++) {
							...
							var html = "<tr onclick='onclickStaffRow(this)'><td><a href='javascript:deleteStaff("
									...
									/* + "<td><a><img style='width:50px;height:38px'  src="+data[i].headimage+"></a></td>" */
									+ "<td>"
...
<body style="text-align: center">
	...
	<div class="breadcrumbs" id="breadcrumbs">
		<ul class="breadcrumb">
			<li><i class="icon-home home-icon"></i> <a href="/webAttendance_ssm/main.jsp">首页</a>
			</li>
			<li><a href="/webAttendance_ssm/main.jsp">人事管理</a>
			</li>
	...
	<div>
		<fieldset>
			...
			<div class="table-responsive"
				style="position:relative;max-height:550px;min-height: 540px;overflow-x: scroll;max-width: 1400px;">
