...
<body>
				...
				<ul class="nav ace-nav">
					<li class="light-blue"><a href="#" data-toggle="dropdown" class="dropdown-toggles">
						...
						<ul
							...
							<li>
									<a href="${ctx}/menuController/updatePassJsp.do">
										<i class="icon-cog"></i>
										设 置密码
									</a>
								</li>
								...
								<li>
									<a href="${ctx}/menuController/information.do">
										<i class="icon-user"></i>
										用户信息
									</a>
								</li>
	...
	<div class="main-container" id="main-container">
				...
				<ul class="nav nav-list">
					...
					<li id="kaoqingtongji"><a href="#" class="dropdown-toggle">
							<i class="icon-tag"></i> <span class="menu-text">
								考勤统计 </span> <b class="arrow icon-angle-down"></b>
					</a>
						<ul class="submenu">
							<li id="gerentongji"
							...
							<li id="gongsitongji"
								 ...
								 'menuController/gongsiattendanceStatistics')">
									<a><i class="icon-double-angle-right"></i> 公司考勤统计 </a>
								</li>
					...
					<%-- <c:if test="${user.remark !='2'}">
						<li id="xiugaimima"><a href="#" class="dropdown-toggle">
								<i class="icon-file-alt"></i> <span class="menu-text">
									修改密码 </span> <b class="arrow icon-angle-down"></b>
						</a>
							<ul class="submenu">
							<li><a href="${ctx}/menuController/alterStaff.do">  个人密码修改
							</a> </li> 
							</ul>
							</li>
					</c:if> --%>
		...
		<ul class="breadcrumb">
			...
			<li><a href="/webAttendance_ssm/main.jsp">个人信息管理</a>
			</li>
