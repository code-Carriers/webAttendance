...
<body style="text-align: center" onclick="hideMenu()">
	<div class="breadcrumbs" id="breadcrumbs">
		<ul class="breadcrumb">
			<li><i class="icon-home home-icon"></i> <a href="/webAttendance_ssm/main.jsp">首页</a></li>
			<li><a href="/webAttendance_ssm/main.jsp">我的考勤</a></li>
	...
	<div id="menuContent" class="menuContent"
		...
		<table border="1" class="table"style="max-width: 2000px;min-width: 1400px;" id="tbGudinglunban">
			...
			<table border="1" class="table"style="max-width: 2000px;min-width: 1400px;" id="tbYuangGong">
